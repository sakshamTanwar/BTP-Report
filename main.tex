...
\section{Introduction}
    ...
    \subsection{Disadvantages of a centralized database}
        ...
        Access to this data is usually provided by a "database management system" (DBMS) consisting of an integrated set of computer software that allows users to interact with one's database and provides access to all of the data contained in the database.
        DBMS provides various functions that allow management of a database and its data \cite{wikidbms}, such as:-
        \begin{itemize}
