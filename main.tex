...
\section{Proposed Solution Architecture}
    ...
    \subsection{Reverse Geocoding Service}
        \paragraph{}
        Reverse Geocoding Service takes GPS coordinates as input and returns the name of State, District, Sub-District and Village where the coordinate belong to. Names and coordinates of places is stored in JSON with the following schema :-
