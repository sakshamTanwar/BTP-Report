...
\section{Proposed Solution Architecture}
    ...
    \subsection{Smartphone Application}
        \paragraph{}
        This application is used to interact with the \gls{lrrs} Server and provide a user-friendly mechanism for the users to request land ownership history records.
